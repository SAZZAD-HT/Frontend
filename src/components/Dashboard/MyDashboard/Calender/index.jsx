...
const Calender=()=>{
    ...
    const WeekOffLists=useSelector((state)=>state.dashboard.weekOffLists)
                    ...
                    <Row >
                        <Col span={24}>
                            ...
                            tileClassName={({ date, view }) => {
                                if(WeekOffLists.length){
                                    if(WeekOffLists.find(x=>moment(new Date(x.WeekoffDate)).format("DD-MM-YYYY")===moment(date).format("DD-MM-YYYY"))){
                                        return  'highlight'
                                    }
                                }
                            }}
